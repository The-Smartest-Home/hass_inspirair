...
class AldesModbusResponse(BaseModel):
    ...
    filter_time: TimeSensor = Field(description=_("filter_time"))
    aux_time_1: TimeSensor = Field(description=_("aux_time_1"))
    aux_time_2: TimeSensor = Field(description=_("aux_time_2"))
    ...
    filter_condition_time: TimeSensor = Field(description=_("filter_condition_time"))
